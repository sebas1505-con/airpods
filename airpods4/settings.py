"""
Django settings for airpods4 project.
...
SECRET_KEY = 'django-insecure-+nhr^xb7nc*n96z&q!z=vr@+e8$@7w%jba1@7ngnp^8#@dsv1a'
...
WSGI_APPLICATION = 'airpods4.wsgi.application'
